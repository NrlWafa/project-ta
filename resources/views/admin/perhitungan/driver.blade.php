    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <td><a href="{{ url('Data_Akhir_Driver') }}" class="btn-sm btn-primary">
                            Hasil Akhir</a>
                    </td>
                        ...
                        <tbody>
                            @php
                                while ($thresholdC1_New != $thresholdC1 && $thresholdC2_New != $thresholdC2) {
                                    ...
                                    $thresholdC2_New = round(($pend_formal_C2_bobot + $pend_nonformal_C2_bobot + $usia_C2_bobot + $lama_kerja_C2_bobot + $sim_C2_bobot) / 5, 1); // Sesuaikan dengan jumlah kualifikasi yg ad di excel
                                    if ($iterasi == 6) {

                        ...
                        <tbody>
                            @php
                                ...
                                while ($thresholdC1_New != $thresholdC1 && $thresholdC2_New != $thresholdC2) {
                                    ...
                                    $thresholdC2_New = round(($pend_formal_C2_bobot + $pend_nonformal_C2_bobot + $usia_C2_bobot + $lama_kerja_C2_bobot) / 4, 1); // Sesuaikan dengan jumlah kualifikasi yang ada di excel

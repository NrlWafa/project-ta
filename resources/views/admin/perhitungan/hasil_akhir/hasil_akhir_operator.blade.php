        ...
        <div class="container-fluid">
            <div class="card">
                        ...
                        <tbody>
                            @php
                                ...
                                while ($thresholdC1_New != $thresholdC1 && $thresholdC2_New != $thresholdC2) {
                                    ...
                                    $thresholdC2_New = round(($pend_formal_C2_bobot + $pend_nonformal_C2_bobot + $usia_C2_bobot + $lama_kerja_C2_bobot + $komp_C2_bobot) / 5, 1); // Sesuaikan dengan jumlah kualifikasi yang ada di excel
                ...
                <div class="card-footer">
                    <a href="{{ url('Data_Operator') }}" class="btn btn-danger">Kembali</a>
                </div>
            </div>
        </div>
    </div>

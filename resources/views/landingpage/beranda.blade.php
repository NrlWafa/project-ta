      ...
      <section id="faq" class="faq">
        <div class="container">
          ...
          <ul class="faq-list">
            ...
            <li>
              <div data-bs-toggle="collapse" class="collapsed question" href="#faq1">Bagaimana cara untuk melakukan pendafataran? <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
              <div id="faq1" class="collapse" data-bs-parent=".faq-list">
                <p>cara untuk melakukan pendaftaran sangat mudah, tinggal klik ajukan lamaran untuk melakaukan pendaftaran, tapi sebelum itu harus buat akun terlebih dahulu</p>
              </div>
            </li>
  
            <li>
              <div data-bs-toggle="collapse" href="#faq2" class="collapsed question">Apakah ada waktu tertentu untuk mengajukan lamaran? <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
              <div id="faq2" class="collapse" data-bs-parent=".faq-list">
                <p>Tidak ada, anda bisa melakukan pendaftaran atau mengajukan lamaran kapanpun</p>
              </div>
            </li>

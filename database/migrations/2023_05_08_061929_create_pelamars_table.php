...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('pelamar', function (Blueprint $table) {
            ...
            //di bawah ini field yang harus diisi sudah ditambahkan nullable(false), masih perlu perbaikan 

            // $table->id();
            // $table->integer('id_user')->length(10);
            // $table->string('nama_lengkap',100)->nullable(false);
            // $table->string('nama_panggilan',100)->nullable(false);
            // $table->enum('jenis_kelamin',['Laki-Laki','Perempuan'])->nullable(false);
            // $table->string('tempat_lahir')->nullable(false);
            // $table->enum('status_perkawinan',['Belum Kawin','Kawin'])->nullable(false);
            // $table->enum('agama',['Islam','Kristen/Protestan','Katolik','Hindu','Budha','Konghucu'])->nullable(false);
            // $table->string('alamat_ktp',100)->nullable(false);
            // $table->string('alamat_dom',100)->nullable(false);
            // $table->string('kel'->nullable(false),100);
            // $table->string('kec',100)->nullable(false);
            // $table->string('kab_kota',100)->nullable(false);
            // $table->string('provinsi',100)->nullable(false);
            // $table->string('no_hp')->nullable(false)->length(15);
            // $table->string('no_telprumah')->length(15);
            // $table->string('no_ktp')->nullable(false)->length(20);
            // $table->integer('tinggi_badan')->length(15);
            // $table->integer('berat_badan')->length(15);
            // $table->enum('uk_baju',['S','M','L','XL','XXL','3XL','4XL']);
            // $table->integer('uk_celana')->length(10);
            ...
            // $table->string('anak2',100);
            // $table->string('anak3',100);
            // $table->string('nama_ayh',100)->nullable(false);
            // $table->string('tmp_lahir_ayh',100)->nullable(false);
            // $table->date('tgl_lahir_ayh')->nullable(false);
            // $table->string('pekerjaan_ayh',100)->nullable(false);
            // $table->string('alamat_ayh',100)->nullable(false);
            // $table->string('no_hp_ayh')->length(15)->nullable(false);
            // $table->string('nama_ibu',100)->nullable(false);
            // $table->string('tmp_lahir_ibu',100)->nullable(false);
            // $table->date('tgl_lahir_ibu')->nullable(false);
            // $table->string('pekerjaan_ibu',100)->nullable(false);
            // $table->string('alamat_ibu',100)->nullable(false);
            // $table->string('no_hp_ibu')->nullable(false)->length(15);
            // $table->enum('gol_dar',['A','B','AB','O']);
            // $table->string('pend_formal',50)->nullable(false);
            // $table->string('tmp_pend',100)->nullable(false);
            // $table->integer('thn_pend')->nullable(false)->length(20);
            // $table->string('jurusan_pend',100)->nullable(false);
            // $table->string('pend_nonformal',50);
            // $table->string('tmp_pend_non',100);
            // $table->integer('thn_pend_non')->length(20);
            // $table->string('jurusan_pend_non',100);
            ...
            // $table->string('bahasa_dikuasai',50);
            // $table->string('organisasi',100);
            // $table->string('nm_kontak',100)->nullable(false);
            // $table->string('no_kontak')->nullable(false)->length(15);
            // $table->string('hubungan',50)->nullable(false);
            // $table->string('no_npwp')->nullable(false)->length(20);
            // $table->string('no_bpjs_ket')->nullable(false)->length(20);
            // $table->string('no_bpjs_kes')->nullable(false)->length(20);
            // $table->enum('jabatan_lamaran',['Satpam','Cleaning Service','Administrasi','Driver','Helper','Teknisi','Operator'])->nullable(false);
            // $table->string('foto_ktp',100)->nullable(false);
            // $table->string('foto_kk',100)->nullable(false);
            // $table->string('foto_kta',100)->nullable(false);
            // $table->string('foto_npwp',100)->nullable(false);
            // $table->string('pas_foto',100)->nullable(false);
            // $table->timestamps();
        });
    }
